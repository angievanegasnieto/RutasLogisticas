...
export class AuthService {
  private base = ''; // Usar rutas relativas para que funcione con el proxy
  ...
  register(name: string, email: string, password: string, role?: string, licencia?: string, telefono?: string) {
    const body: any = { name, email, password, role };
    if (licencia) body.licencia = licencia;
